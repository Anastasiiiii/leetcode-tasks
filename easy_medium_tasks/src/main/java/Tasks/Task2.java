...
public class Task2 {
    ...
    private static int dif(int[] seats, int[] students, int n) {
    ...
    private static int sum(int[] seats, int[] students) {
        int sum = 0;
    ...
    private static void mergeElements(int[] nums1, int m, int[] nums2, int n) {
        int i = m - 1;
        int j = n - 1;
        int k = m + n - 1;
